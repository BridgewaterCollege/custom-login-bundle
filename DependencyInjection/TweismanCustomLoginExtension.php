...
class TweismanCustomLoginExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        //$configuration = new Configuration();
        $config = $this->processConfiguration($configuration, $configs);
        $sillyServiceDefintion = $container->getDefinition( 'Tweisman\Bundle\CustomLoginBundle\Security\User\UserCreator' );
